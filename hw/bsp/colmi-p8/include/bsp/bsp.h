...
/* 2 wire power button */
#define PUSH_BUTTON_IN_PIN      17 /* P0.13 PUSH BUTTON_IN       IN */
...
#define LCD_DET_PIN             12 /* P0.09 LCD_DET              OUT */
#define LCD_RS_PIN              18 /* P0.18 LCD_RS               OUT */
...
#define LCD_CS_PIN              25 /* P0.25 LCD_CS               OUT */
...
#define ACCELEROMETER_TWI_ADDR	0x18
...
#define TOUCH_RESET_PIN         13 /* P0.10 TP_RESET                         OUT */

/* Heartrate sensor i2c */
#define HEARTRATE_TWI_ADDR	0x44
...
#define HEARTRATE_AUX_LED       27 /* P0.27 AUX LEDs near sensor             OUT */
